package
{
     ...
     public class MotionCanvas
     {
		...
		public function MotionCanvas(w:int=640,h:int=480){
			...
			*/
              ...
              // _W= Math.floor(_fixedW/ _fixedCellSize /_cellSizeW)*_cellSizeW;	 
		 	//_H= Math.floor(_fixedH/ _fixedCellSize /_cellSizeH)*_cellSizeH;

			//_cellSize=_fixedCellSize*ratio;
		...
		public function drawMotion(motionMap:Array):void{
          /*
		...
		FE: 0-while,1-black
		   ...
		   that line would be [0,4,1,3,0,5,1,2], 0*4+1*3+0*5+1*2 

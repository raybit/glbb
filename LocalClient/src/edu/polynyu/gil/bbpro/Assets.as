package edu.polynyu.gil.bbpro 
{
	...
	public class Assets 
	{
		...
		[Embed(source = '/assets/grad_bg.jpg')] public static const BG_img:Class;
		[Embed(source = '/assets/plus.gif')] public static const plus:Class;

		[Embed(source = "/assets/dog.jpg")] public static const BG_dog:Class;

...
class MotionDataHandler(object):
    ...
    def startProcess(self):
        ...
        self.objmngr.scanRealMobj(self.packAndSendAutoUpdateMsg )

# now : no socket code, no pubnub,
    def processAndSendJsonPkg(self,jsonMsg):
    ...
    def packAndSendAutoUpdateMsg(self,motionListObj):
...
"""
#=================================================================================
''' old code for garden v1.0 three sections
